Resource: Dynamic Lighting v1.2
contact: ReflexDev#7334
en ver:
Update v1.5.8
-added dimension and interior flags for create spot/point light
-added setLightInterior, getLightInterior, setLightDimension, getLightDimension exports
Update v1.5.6
-added an option to create vertex lights for a number of enabled lights
-set setForceVertexLight for peds and vehicles to true
-added setVertexLights and setForceVertexLights exported functions
Update v1.5.0
